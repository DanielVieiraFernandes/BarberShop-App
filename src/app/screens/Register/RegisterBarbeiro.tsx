...
export type MyBarberSchema = z.infer<typeof barberSchema>;

export function RegisterBarbeiro() {
  const [isChecked, setChecked] = useState<boolean>(false);
  const { cadastrarBarbeiro, isLoading} = useAuth();
      ...
      <Box flex={1} backgroundColor="background">
        ...
        <Box alignItems="center" marginVertical="xl">
          ...
          <Text>
            ...
            <Text
              color="orange"
              onPress={() => navigation.navigate("SignInBarber")}
            >
              login
            </Text>{" "}
            agora
        ...
        <Box flex={1} alignItems="center" gap="l">
          ...
          <ButtonB
            title="Cadastrar"
            buttonProps={{
              onPress: handleSubmit(cadastrarBarbeiro),
            }}
          />
        </Box>
      </Box>
